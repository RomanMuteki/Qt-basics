...
QT_MOC_LITERAL(1, 5, 15), // "authentificated"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 17) // "confirm_isclicked"

    },
    "Auth\0authentificated\0\0confirm_isclicked"
};
...
void Auth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->authentificated((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->confirm_isclicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Auth::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Auth::authentificated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Auth::authentificated(bool _t1)
{
